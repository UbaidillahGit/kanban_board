...
// in kanban_board/test/bloc/login_social/login_social_test.dart.
...
class MockSecureStorageRepository extends _i1.Mock
  ...
  @override
  _i7.Future<String?> getUserEmail() => (super.noSuchMethod(
        Invocation.method(
          #getUserEmail,
          [],
        ),
  ...
  @override
  _i7.Future<String?> getUserPhotoUrl() => (super.noSuchMethod(
        Invocation.method(
          #getUserPhotoUrl,
          [],
        ),
  ...
  @override
  _i7.Future<String?> getCurrentOpenedProject() => (super.noSuchMethod(
        Invocation.method(
